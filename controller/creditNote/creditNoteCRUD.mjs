    ...
    try {
        ...
        const request = new sql.Request()
            ...
            .query(`
                ...
                LEFT JOIN tbl_Trip_Details AS td ON td.Credit_Note_Id = gi.CR_Id
                LEFT JOIN tbl_Trip_Master AS tm ON tm.Trip_Id = td.Trip_Id
                WHERE 
                    gi.CR_Id IN (SELECT CR_Id FROM @FilteredInvoice)
                ...
                SELECT
                    ...
                    COALESCE(bm.Brand_Name, 'not available') AS BrandGet
                ...
                WHERE 
                    exp.CR_Id IN (SELECT DISTINCT CR_Id FROM @FilteredInvoice)
...
export const createCreditNote = async (req, res) => {
    ...
    try {
        ...
        const request = new sql.Request(transaction)
            ...
            .input('Total_Invoice_value', sql.Decimal(18, 2), RoundNumber(Addition(Total_Invoice_value, toNumber(Round_off))))
